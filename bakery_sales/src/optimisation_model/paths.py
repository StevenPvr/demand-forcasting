...
"""Chemins centralises pour les artefacts d'optimisation du modele actif."""
...
TRIALS_CSV: Path = DATA_OPTIMISATION_DIR / "elasticnet_optuna_trials.csv"
BEST_MODEL_PKL: Path = DATA_OPTIMISATION_DIR / "elasticnet_best_model.pkl"
BEST_PREDICTIONS_CSV: Path = DATA_OPTIMISATION_DIR / "elasticnet_best_trial_predictions.csv"
