...
window_lagged as (
    select
        *,
        ...
        lead(holiday_name, 1) over series_window as target_holiday_name_raw,
        lead(school_holiday_flag, 1) over series_window as target_school_holiday_flag,
        lead(school_holiday_name, 1) over series_window as target_school_holiday_name_raw
    from window_inputs
    window
        series_window as (
...
window_features as (
    select
        ...
        case
            when holiday_flag then coalesce(holiday_name, 'holiday_unspecified')
            else 'no_holiday'
        end as current_holiday_name,
        case
            when school_holiday_flag then coalesce(school_holiday_name, 'school_holiday_unspecified')
            else 'no_school_holiday'
        end as current_school_holiday_name,
        case
            when target_holiday_flag then coalesce(target_holiday_name_raw, 'holiday_unspecified')
            else 'no_holiday'
        end as target_holiday_name,
        case
            when target_school_holiday_flag then coalesce(target_school_holiday_name_raw, 'school_holiday_unspecified')
            else 'no_school_holiday'
        end as target_school_holiday_name,
...
final_panel as (
    select
        ...
        base_panel.site_format,
        base_panel.service_model,
        base_panel.drive_through_flag,
        base_panel.delivery_flag,
        base_panel.pickup_flag,
        base_panel.late_night_flag,
        base_panel.trade_area_type,
        base_panel.office_density_bucket,
        base_panel.residential_density_bucket,
        base_panel.competition_intensity_bucket,
        base_panel.product_family,
        base_panel.product_subfamily,
        base_panel.menu_role,
        base_panel.price_band,
        ...
        split_labeled.current_holiday_name,
        base_panel.activity_flag,
        base_panel.school_holiday_flag,
        split_labeled.current_school_holiday_name,
        base_panel.bridge_day_flag,
        base_panel.pre_holiday_flag,
        base_panel.post_holiday_flag,
        base_panel.holiday_name_local,
        base_panel.school_holiday_flag_local,
        base_panel.school_holiday_name_local,
        base_panel.payday_flag,
        ...
        split_labeled.target_school_holiday_name,
