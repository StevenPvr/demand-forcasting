...
from research_praedixa.global_dataset.commercial_external import freshretail_promo_flag_expr
from research_praedixa.global_dataset.schema import align_lazy_frame_to_canonical_schema, build_series_id_expr


DEFAULT_TRAIN_INPUT_PATH = Path("data/bakery_sales/data_train.parquet")
DEFAULT_VAL_INPUT_PATH = Path("data/bakery_sales/data_val.parquet")
DEFAULT_OUTPUT_PATH = Path("data/global_dataset/freshretail_daily.parquet")
