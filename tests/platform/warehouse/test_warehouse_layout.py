...
class WarehouseLayoutTests(unittest.TestCase):
    ...
    def test_gold_model_references_feature_panel(self) -> None:
        ...
        self.assertIn("gdp_current_usd_latest_delta_28", sql)
        self.assertIn("fr_business_climate_latest", sql)
        self.assertIn("fr_cpi_yoy_latest", sql)
        ...
        self.assertIn('"promo_flag"', sql)
        self.assertIn('"weather_temperature_lag_1"', sql)
        self.assertIn("{{ base }}_status", sql)
