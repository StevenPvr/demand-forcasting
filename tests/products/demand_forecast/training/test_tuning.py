...
class TuningPolicyTests(unittest.TestCase):
    ...
    def test_hpo_resolved_inputs_apply_gpu_runtime_profile_defaults(self) -> None:
        ...
        self.assertFalse(bool(resolved_params["enable_business_validation_metrics"]))
        self.assertFalse(bool(resolved_params["enable_device_stats_monitor"]))
        self.assertEqual(resolved_params["validation_monitor_metric"], "val_loss")
        self.assertEqual(int(resolved_params["loss_patience"]), 0)
