...
from praedixa.demand_forecast.training.tuning_policy import sample_optuna_params  # noqa: E402


class TuningPolicyTests(unittest.TestCase):
    def test_scaleway_l40s_uses_large_gpu_batch_space(self) -> None:
    ...
    def test_local_cpu_keeps_default_batch_space(self) -> None:
