...
from research_praedixa.global_dataset.bakery import build_bakery_standardized_dataset, parse_bakery_unit_price  # noqa: E402


class GlobalDatasetBakeryTests(unittest.TestCase):
    def test_parse_bakery_unit_price_parses_french_money_strings(self) -> None:
        self.assertAlmostEqual(parse_bakery_unit_price("1,20 €"), 1.2, places=6)
